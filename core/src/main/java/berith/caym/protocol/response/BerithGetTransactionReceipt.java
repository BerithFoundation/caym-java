...
/**
 * response of berith_getTransactionReceipt
 */
public class BerithGetTransactionReceipt extends Response<TransactionReceipt> {

    public Optional<TransactionReceipt> getTransactionReceipt() {
        return Optional.ofNullable(getResult());
    }

    public static class ResponseDeserializer extends JsonDeserializer<TransactionReceipt> {
