...
import berith.caym.protocol.response.BerithSyncing.Result;
...
/**
 * response of berith_syncing
 *
 * if syncing, then use {@link Syncing}, otherwise use {@link Result}
 */
public class BerithSyncing extends Response<Result> {
    ...
    public static class Syncing extends Result {
        ...
        public boolean equals(Object o) {
            ...
            if (!Objects.equals(knownStates, syncing.knownStates)) {
                return false;
            }
            return Objects.equals(pulledStates, syncing.pulledStates);
        }
    ...
    public static class ResponseDeserializer extends JsonDeserializer<Result> {
